...
- The new device should appear in the device list. Copy its ID to the clipboard
...
- Open the Mongoose Mobile app and login to the cloud. Use the UI to switch LED
  on/off.
