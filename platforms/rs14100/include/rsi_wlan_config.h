...
#define RSI_MODE_11N_ENABLE RSI_ENABLE
...
//! 0 - module wakes up at beacon which is just before or equal to
// listen_interval
//! 1 - module wakes up at DTIM beacon which is just before or equal to
// listen_interval
...
#define HIGH_PERFORMANCE_ENABLE \
  RSI_ENABLE  //@ RSI_ENABLE or RSI_DISABLE High performance socket

#define TOTAL_SOCKETS \
  0  //@ Total number of sockets. TCP TX + TCP RX + UDP TX + UDP RX
#define TOTAL_TCP_SOCKETS 0    //@ Total TCP sockets. TCP TX + TCP RX
...
#define TCP_RX_HIGH_PERFORMANCE_SOCKETS \
  0                                //@ Total TCP RX High Performance sockets
...
//! RSI_BAND_2P4GHZ(2.4GHz) or RSI_BAND_5GHZ(5GHz) or RSI_DUAL_BAND
#define RSI_CONFIG_AP_BAND RSI_DUAL_BAND
//! Tx power level
#define RSI_CONFIG_AP_TX_POWER RSI_POWER_LEVEL_HIGH
//! AP SSID
#define RSI_CONFIG_AP_SSID "OHAI"
...
//! TCP_STACK_USED BIT(0) - IPv4, BIT(1) -IPv6, (BIT(0) | BIT(1)) - Both IPv4
// and IPv6
