...
struct mgos_uart_dev_config {
   ...
   *
   * UART 0: Rx: 17, Tx: 16 (IOMUX defaults on ESP32-C6)
   * UART 1: Rx: 4, Tx: 5 (routed via GPIO matrix)
   */
...
int esp32c6_uart_rx_fifo_len(int uart_no);
int esp32c6_uart_tx_fifo_len(int uart_no);
bool esp32c6_uart_cts(int uart_no);
