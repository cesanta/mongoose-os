...
#ifndef CS_SMARTJS_PLATFORMS_ESP8266_USER_ESP_SPI_REGISTER_H_
#define CS_SMARTJS_PLATFORMS_ESP8266_USER_ESP_SPI_REGISTER_H_
...
#define SPI_CTRL1(i) (REG_SPI_BASE(i) + 0xC) /* From previous SDK */
...
* mode 1 : negedge + 1 cycle delay, only if freq<10MHz ; data set at negitive
* edge of clk
...
#define SPI_EXT0(i) (REG_SPI_BASE(i) + 0xF0) /* From previous SDK */.
...
#define SPI_EXT1(i) (REG_SPI_BASE(i) + 0xF4) /* From previous SDK */.
...
#define SPI_EXT2(i) (REG_SPI_BASE(i) + 0xF8) /* From previous SDK */
...
#endif /* CS_SMARTJS_PLATFORMS_ESP8266_USER_ESP_SPI_REGISTER_H_ */
