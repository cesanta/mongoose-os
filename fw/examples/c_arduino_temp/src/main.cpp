...
// in read-only memory (ROM). You can find it with search() function as shown
// below.
static const unsigned char sens[NUM_SENS][8] = {
    {0x28, 0xe6, 0x17, 0xa1, 0x08, 0x00, 0x00, 0xab},
