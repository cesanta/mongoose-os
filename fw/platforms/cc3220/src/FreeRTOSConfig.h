...
#ifndef CS_FW_PLATFORMS_CC3220_SRC_FREERTOSCONFIG_H_
#define CS_FW_PLATFORMS_CC3220_SRC_FREERTOSCONFIG_H_
...
/* Note: Only for FreeRTOS's internal use (pvPortMalloc(), vPortFree()),
 * malloc() and free() are UMM */
...
#endif /* CS_FW_PLATFORMS_CC3220_SRC_FREERTOSCONFIG_H_ */
