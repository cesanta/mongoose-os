...
#ifndef CS_FW_PLATFORMS_ESP8266_USER_ESP_SPI_REGISTER_H_
#define CS_FW_PLATFORMS_ESP8266_USER_ESP_SPI_REGISTER_H_
...
#endif /* CS_FW_PLATFORMS_ESP8266_USER_ESP_SPI_REGISTER_H_ */
