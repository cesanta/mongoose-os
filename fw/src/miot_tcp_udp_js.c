...
static enum v7_err tcp_connect(struct v7 *v7, v7_val_t this_obj,
  ...
  c = mg_connect_opt(miot_get_mgr(), addr, mg_ev_handler, conn_opts);
...
static enum v7_err udp_tcp_start_listen(struct v7 *v7, v7_val_t *res,
  ...
  c = mg_bind_opt(miot_get_mgr(), bind_addr, mg_ev_handler, opts);
...
MG_PRIVATE enum v7_err DGRAM_Socket_send(struct v7 *v7, v7_val_t *res) {
  ...
  c = mg_connect(miot_get_mgr(), mg_addr, mg_ev_handler);
