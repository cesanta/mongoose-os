...
*
*/
enum v7_err mg_ws_ctor(struct v7 *v7, v7_val_t *res) {
  ...
  if (v7_is_object(this_obj) && this_obj != v7_get_global(v7)) {
    ...
    nc = mg_connect_ws_opt(mg_get_mgr(), ws_ev_handler, copts, url, proto,
                           extra_headers);
    if (nc == NULL) {
...
void mg_ws_client_api_setup(struct v7 *v7) {
  v7_val_t ws_proto = v7_mk_object(v7);
  v7_val_t ws = v7_mk_function_with_proto(v7, mg_ws_ctor, ws_proto);
  v7_own(v7, &ws);
