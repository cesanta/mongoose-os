...
ifeq "$(MIOT_ENABLE_GPIO_SERVICE)" "1"
  MIOT_SRCS += miot_gpio_service.c
  MIOT_FEATURES += -DMIOT_ENABLE_GPIO_SERVICE
endif
ifeq "$(MIOT_ENABLE_I2C_SERVICE)" "1"
  MIOT_SRCS += miot_i2c_service.c
  MIOT_FEATURES += -DMIOT_ENABLE_I2C_SERVICE
endif
ifeq "$(MIOT_ENABLE_SYS_SERVICE)" "1"
  MIOT_FEATURES += -DMIOT_ENABLE_SYS_SERVICE
endif
ifeq "$(MIOT_ENABLE_RPC_CHANNEL_HTTP)" "1"
  MIOT_SRCS += mg_rpc_channel_http.c
  MIOT_FEATURES += -DMIOT_ENABLE_RPC_CHANNEL_HTTP
endif
ifeq "$(MIOT_ENABLE_RPC_CHANNEL_MQTT)" "1"
  MIOT_SRCS += miot_rpc_channel_mqtt.c
  MIOT_FEATURES += -DMIOT_ENABLE_RPC_CHANNEL_MQTT
  SYS_CONF_SCHEMA += $(MIOT_SRC_PATH)/miot_rpc_channel_mqtt_config.yaml
else
  MIOT_FEATURES += -DMIOT_ENABLE_RPC_CHANNEL_MQTT=0
endif
...
export MIOT_ENABLE_GPIO_SERVICE
...
export MIOT_ENABLE_RPC_CHANNEL_MQTT
export MIOT_ENABLE_RPC_CHANNEL_UART
export MIOT_ENABLE_SYS_SERVICE
