...
#ifndef CS_FW_SRC_SJ_INIT_CLUBBY_H_
#define CS_FW_SRC_SJ_INIT_CLUBBY_H_
...
struct clubby_cfg *clubby_cfg_from_sys(const struct sys_config_clubby *);
...
#endif /* CS_FW_SRC_SJ_INIT_CLUBBY_H_ */
