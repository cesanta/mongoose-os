...
static enum v7_err Sys_prof(struct v7 *v7, v7_val_t *res) {
  *res = v7_mk_object(v7);
  ...
  v7_set(v7, *res, "sysfree", ~0, v7_mk_number(v7, mg_get_free_heap_size()));
  v7_set(v7, *res, "min_sysfree", ~0,
         v7_mk_number(v7, mg_get_min_free_heap_size()));
  v7_set(v7, *res, "used_by_js", ~0,
         v7_mk_number(v7, v7_heap_stat(v7, V7_HEAP_STAT_HEAP_USED)));
  v7_set(v7, *res, "used_by_fs", ~0,
         v7_mk_number(v7, mg_get_fs_memory_usage()));
...
static enum v7_err Sys_wdtSetTimeout(struct v7 *v7, v7_val_t *res) {
  ...
  if (!v7_is_number(timeoutv)) {
    ...
    mg_wdt_set_timeout(v7_get_double(v7, timeoutv));
  }
...
MG_PRIVATE enum v7_err Sys_fs_getFreeSpace(struct v7 *v7, v7_val_t *res) {
  *res = v7_mk_number(v7, mg_get_storage_free_space());
  return V7_OK;
}
...
MG_PRIVATE enum v7_err GC_stat(struct v7 *v7, v7_val_t *res) {
  ...
  size_t sysfree = mg_get_free_heap_size();
...
void _mg_invoke_cb(struct v7 *v7, v7_val_t func, v7_val_t this_obj,
  ...
  if (v7_apply(v7, func, this_obj, args, &res) == V7_EXEC_EXCEPTION) {
    mg_print_exception(v7, res, "cb threw exception");
  }
}

void mg_invoke_cb2_this(struct v7 *v7, v7_val_t cb, v7_val_t this_obj,
  ...
  mg_invoke_cb(v7, cb, this_obj, args);
  v7_disown(v7, &args);
  v7_disown(v7, &arg2);
  v7_disown(v7, &arg1);
  v7_disown(v7, &cb);
...
void mg_invoke_cb1_this(struct v7 *v7, v7_val_t cb, v7_val_t this_obj,
                        v7_val_t arg) {
  v7_val_t args;
  v7_own(v7, &cb);
  v7_own(v7, &arg);
...
void mg_invoke_cb0(struct v7 *v7, v7_val_t cb) {
  mg_invoke_cb0_this(v7, cb, v7_get_global(v7));
}

void mg_invoke_cb1(struct v7 *v7, v7_val_t cb, v7_val_t arg) {
  mg_invoke_cb1_this(v7, cb, v7_get_global(v7), arg);
}

void mg_invoke_cb2(struct v7 *v7, v7_val_t cb, v7_val_t arg1, v7_val_t arg2) {
  mg_invoke_cb2_this(v7, cb, v7_get_global(v7), arg1, arg2);
}
