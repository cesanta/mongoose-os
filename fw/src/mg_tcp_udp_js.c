...
static int trigger_event(struct v7 *v7, struct cb_info_holder *list,
  ...
  SLIST_FOREACH_SAFE(cb, &list->head, entries, cb_temp) {
    if (strcmp(cb->name, name) == 0) {
      ...
      mg_invoke_cb2(v7, cb->cbv, arg1, arg2);
      ret = 1;
      if (cb->trigger_once) {
...
static void async_trigger_event(struct v7 *v7, v7_val_t obj,
  ...
  mg_set_c_timer(0, 0, async_trigger_event_cb, params);
}
...
static enum v7_err udp_tcp_start_listen(struct v7 *v7, v7_val_t *res,
  ...
  c = mg_bind_opt(mg_get_mgr(), bind_addr, mg_ev_handler, opts);
 ...
 */
MG_PRIVATE enum v7_err DGRAM_createSocket(struct v7 *v7, v7_val_t *res) {
  enum v7_err rcode = V7_OK;
...
MG_PRIVATE enum v7_err DGRAM_Socket_send(struct v7 *v7, v7_val_t *res) {
  enum v7_err rcode = V7_OK;
  ...
  c = mg_connect(mg_get_mgr(), mg_addr, mg_ev_handler);
...
MG_PRIVATE enum v7_err DGRAM_Socket_close(struct v7 *v7, v7_val_t *res) {
 ...
 */
MG_PRIVATE enum v7_err DGRAM_Socket_bind(struct v7 *v7, v7_val_t *res) {
...
MG_PRIVATE enum v7_err DGRAM_Socket_on(struct v7 *v7, v7_val_t *res) {
 ...
 */
MG_PRIVATE enum v7_err TCP_connect(struct v7 *v7, v7_val_t *res) {
  return tcp_connect(v7, V7_UNDEFINED, res);
}

/* net.createServer([options][, connectionListener]) */
MG_PRIVATE enum v7_err TCP_createServer(struct v7 *v7, v7_val_t *res) {
  enum v7_err rcode = V7_OK;
 ...
 */
MG_PRIVATE enum v7_err TCP_createConnection(struct v7 *v7, v7_val_t *res) {
  return tcp_connect(v7, V7_UNDEFINED, res);
}

/* server.close([callback]) */
MG_PRIVATE enum v7_err TCP_Server_close(struct v7 *v7, v7_val_t *res) {
  return udp_tcp_close_conn(v7, res, s_ev_close);
}

/* server.getConnections(callback) */
MG_PRIVATE enum v7_err TCP_Server_getConnections(struct v7 *v7, v7_val_t *res) {
  enum v7_err rcode = V7_OK;
 ...
 */
MG_PRIVATE enum v7_err TCP_Server_listen(struct v7 *v7, v7_val_t *res) {
  /*
...
/* emitter.on(event, listener) */
MG_PRIVATE enum v7_err TCP_Server_on(struct v7 *v7, v7_val_t *res) {
...
MG_PRIVATE enum v7_err TCP_Socket_ctor(struct v7 *v7, v7_val_t *res) {
  /*
 ...
 */
MG_PRIVATE enum v7_err TCP_Socket_connect(struct v7 *v7, v7_val_t *res) {
  return tcp_connect(v7, v7_get_this(v7), res);
}

/* socket.write(data[, encoding][, callback]) */
MG_PRIVATE enum v7_err TCP_Socket_write(struct v7 *v7, v7_val_t *res) {
  enum v7_err rcode = V7_OK;
  struct mg_connection *c;
...
MG_PRIVATE enum v7_err TCP_Socket_end(struct v7 *v7, v7_val_t *res) {
  enum v7_err rcode = V7_OK;
  struct mg_connection *c;
...
/* socket.destroy() */
MG_PRIVATE enum v7_err TCP_Socket_destroy(struct v7 *v7, v7_val_t *res) {
  enum v7_err rcode = V7_OK;
  struct mg_connection *c;
  rcode = get_connection(v7, v7_get_this(v7), &c);
  if (rcode != V7_OK) {
...
/* socket.pause() */
MG_PRIVATE enum v7_err TCP_Socket_pause(struct v7 *v7, v7_val_t *res) {
  return set_paused(v7, res, 1);
}

/* socket.resume() */
MG_PRIVATE enum v7_err TCP_Socket_resume(struct v7 *v7, v7_val_t *res) {
  return set_paused(v7, res, 0);
}

/* socket.setTimeout(timeout[, callback]) */
MG_PRIVATE enum v7_err TCP_Socket_setTimeout(struct v7 *v7, v7_val_t *res) {
  enum v7_err rcode = V7_OK;
  struct mg_connection *c;
...
/* emitter.on(event, listener) */
MG_PRIVATE enum v7_err TCP_Socket_on(struct v7 *v7, v7_val_t *res) {
